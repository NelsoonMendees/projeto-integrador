...
public class Tela4x4 extends AppCompatActivity implements View.OnClickListener {
    ...
    Integer[] posicaoImg = {101, 102, 103, 104, 105, 106, 107, 108, 201, 202, 203, 204, 205, 206, 207, 208};

    int imgJogo1, imgJogo2, imgJogo3, imgJogo4, imgJogo5, imgJogo6;
    int imgJogo7, imgJogo8, imgJogo9, imgJogo10, imgJogo11, imgJogo12;
    int imgJogo13, imgJogo14, imgJogo15, imgJogo16;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tela4x4);
    ...
    private void iniciar() {
        ...
        //Linha 1
        L1xC1 = findViewById(R.id.imgBt4x4_L1xC1);
        L1xC1.setOnClickListener(this);

        L1xC2 = findViewById(R.id.imgBt4x4_L1xC2);
        L1xC2.setOnClickListener(this);

        L1xC3 = findViewById(R.id.imgBt4x4_L1xC3);
        L1xC3.setOnClickListener(this);

        L1xC4 = findViewById(R.id.imgBt4x4_L1xC4);
        L1xC4.setOnClickListener(this);

        //Linha 2
        L2xC1 = findViewById(R.id.imgBt4x4_L2xC1);
        L2xC1.setOnClickListener(this);

        L2xC2 = findViewById(R.id.imgBt4x4_L2xC2);
        L2xC2.setOnClickListener(this);

        L2xC3 = findViewById(R.id.imgBt4x4_L2xC3);
        L2xC3.setOnClickListener(this);

        L2xC4 = findViewById(R.id.imgBt4x4_L2xC4);
        L2xC4.setOnClickListener(this);

        //Linha 3
        L3xC1 = findViewById(R.id.imgBt4x4_L3xC1);
        L3xC1.setOnClickListener(this);

        L3xC2 = findViewById(R.id.imgBt4x4_L3xC2);
        L3xC2.setOnClickListener(this);

        L3xC3 = findViewById(R.id.imgBt4x4_L3xC3);
        L3xC3.setOnClickListener(this);

        L3xC4 = findViewById(R.id.imgBt4x4_L3xC4);
        L3xC4.setOnClickListener(this);

        //Linha 4
        L4xC1 = findViewById(R.id.imgBt4x4_L4xC1);
        L4xC1.setOnClickListener(this);

        L4xC2 = findViewById(R.id.imgBt4x4_L4xC2);
        L4xC2.setOnClickListener(this);

        L4xC3 = findViewById(R.id.imgBt4x4_L4xC3);
        L4xC3.setOnClickListener(this);

        L4xC4 = findViewById(R.id.imgBt4x4_L4xC4);
    ...
    private void imagensJogo() {
        ...
        imgJogo1 = R.drawable.owl;
        imgJogo2 = R.drawable.bomb;
        imgJogo3 = R.drawable.mouse;
        imgJogo4 = R.drawable.polarbear;
        imgJogo5 = R.drawable.redpanda;
        imgJogo6 = R.drawable.raccoon;
        imgJogo7 = R.drawable.rhino;
        imgJogo8 = R.drawable.goat;

        imgJogo9 = R.drawable.owl;
        imgJogo10 = R.drawable.bomb;
        imgJogo11 = R.drawable.mouse;
        imgJogo12 = R.drawable.polarbear;
        imgJogo13 = R.drawable.redpanda;
        imgJogo14 = R.drawable.raccoon;
        imgJogo15 = R.drawable.rhino;
        imgJogo16 = R.drawable.goat;
    }
    ...
    private void validaFimDeJogo() {
        if (duasImagens1 == 2 && duasImagens3 == 2 && duasImagens4 == 2
            ...
            Intent passaFase = new Intent(getApplication(), Tela5x4.class);
