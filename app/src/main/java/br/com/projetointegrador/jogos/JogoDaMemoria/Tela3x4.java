...
public class Tela3x4 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tela3x4);
    ...
    private void iniciar() {
        ...
        //Linha 1
        L1xC1 = findViewById(R.id.imgBt3x4_L1xC1);
        L1xC1.setOnClickListener(this);

        L1xC2 = findViewById(R.id.imgBt3x4_L1xC2);
        L1xC2.setOnClickListener(this);

        L1xC3 = findViewById(R.id.imgBt3x4_L1xC3);
        L1xC3.setOnClickListener(this);

        L1xC4 = findViewById(R.id.imgBt3x4_L1xC4);
        L1xC4.setOnClickListener(this);

        //Linha 2
        L2xC1 = findViewById(R.id.imgBt3x4_L2xC1);
        L2xC1.setOnClickListener(this);

        L2xC2 = findViewById(R.id.imgBt3x4_L2xC2);
        L2xC2.setOnClickListener(this);

        L2xC3 = findViewById(R.id.imgBt3x4_L2xC3);
        L2xC3.setOnClickListener(this);

        L2xC4 = findViewById(R.id.imgBt3x4_L2xC4);
        L2xC4.setOnClickListener(this);

        //Linha 3
        L3xC1 = findViewById(R.id.imgBt3x4_L3xC1);
        L3xC1.setOnClickListener(this);

        L3xC2 = findViewById(R.id.imgBt3x4_L3xC2);
        L3xC2.setOnClickListener(this);

        L3xC3 = findViewById(R.id.imgBt3x4_L3xC3);
        L3xC3.setOnClickListener(this);

        L3xC4 = findViewById(R.id.imgBt3x4_L3xC4);
    ...
    private void imagensJogo() {
        ...
        imgJogo1 = R.drawable.lion;
        imgJogo2 = R.drawable.bomb;
        imgJogo3 = R.drawable.buffalo;
        imgJogo4 = R.drawable.jaguar;
        imgJogo5 = R.drawable.zebra;
        imgJogo6 = R.drawable.panda;

        imgJogo7 = R.drawable.lion;
        imgJogo8 = R.drawable.bomb;
        imgJogo9 = R.drawable.buffalo;
        imgJogo10 = R.drawable.jaguar;
        imgJogo11 = R.drawable.zebra;
        imgJogo12 = R.drawable.panda;
    }
    ...
    private void validaFimDeJogo() {
        if (duasImagens1 == 2 && duasImagens3 == 2 && duasImagens4 == 2
            ...
            Intent passaFase = new Intent(getApplication(), Tela4x3.class);
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        if (contaTempo > 0) {
                            ...
                            tempo.cancel();
                            Toast.makeText(Tela3x4.this, "SEU TEMPO ACABOU! TENTE NOVAMENTE", Toast.LENGTH_LONG).show();
                            finish();
                        }
                    }
                });
